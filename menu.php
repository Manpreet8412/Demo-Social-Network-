...
?>
<tr>
    <td height="30" align="center" valign="middle"> <a href="index.html">Home</a>|<a href="forgotpass.php">Forgot pass</a>|<a href="profile.php">Profile</a>|<a href="delete.php?del=<?php echo $_SESSION['email']; ?>">delete</a>|<a href="logout.php">Logout</a></td>
  </tr>
  <tr>
